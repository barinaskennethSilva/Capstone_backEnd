...
<li class="nav-item">
<a class="nav-link text-white fw-bold nav-dash" href="{{ route('Therapist_list') }}"><i class="bi bi-bookmarks icons"></i><label class="nav-label me-4">Therapist List</label></a>
</li>
<li class="nav-item">
<a class="login-btn nav-link text-white fw-bold nav-dash" href="{{ route('Profit_report') }}"><i class="bi bi-calendar3 icons"></i><label class="nav-label me-4"> Profit Report</label></a>
</li>
<li class="nav-item">
...
<li class="nav-item">
<a class="nav-link text-white fw-bold nav-dash" href="{{ route('Register_therapist') }}" @click="dashOpen"><i class="bi bi-bookmarks icons"></i><label class="nav-label ms-4">Register Therapist</label></a>
</li>
<li class="nav-item">
<a class="login-btn nav-link text-white fw-bold nav-dash" href="{{ route('Profit_report') }}" @click="dashOpen"><i class="bi bi-calendar3 icons"></i><label class="nav-label" style="position:relative;right:29px;"> Profit report</label></a>
</li>
<li class="nav-item">
<a class="login-btn nav-link text-white fw-bold nav-dash" href="{{ route('admin_message') }}" @click="dashOpen"><i class="bi bi-chat-dots icons"></i><label class="nav-label " style="position:relative;right:20px;"> Message</label></a>
</li>
<li class="nav-item">
<a class="login-btn nav-link text-white fw-bold nav-dash" href="{{route('Therapist_list')}}" @click="dashOpen"><i class="bi bi-box-arrow-left icons"></i><label class="nav-label " style="position:relative;right:32px;"> Therapist list</label></a>
</li>
</ul>
</div>
